			...
			<div class="row">
				<%
					...
					for (int i = 0; i < list.size(); i++) {
						...
						String delHtmlContent = HtmlRegexpUtil.delHTMLTag(description);
						String digest = delHtmlContent.length() > 60
								? delHtmlContent.substring(0, 60) + "......"
								: delHtmlContent;

						out.print("<div class='card'>");
						out.print("<a href='/acne/goods_home/"+goodsId+"'>");
						out.print("<img data-src='" + image+ "' alt='Card image cap' style='height: 280px; width: 100%; display: block;'>");
						out.print("</a>");
